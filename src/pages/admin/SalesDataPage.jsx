          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-4">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex-1 sm:flex-none rounded-md bg-gradient-to-r from-blue-500 to-indigo-600 py-2 px-3 sm:px-4 text-white hover:from-blue-600 hover:to-indigo-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 text-sm sm:text-base"
              >
                {showHistory ? (
                  <div className="flex items-center justify-center">
              ...
              {!showHistory && (
                <button
                  ...
                  className="flex-1 sm:flex-none rounded-md bg-gradient-to-r from-purple-600 to-pink-600 py-2 px-3 sm:px-4 text-white hover:from-purple-700 hover:to-pink-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed text-sm sm:text-base"
                >
